      ...
      if(this.readyState == 4 && this.status == 200) {
        ...
        for (var i = 0; i < this.response.length; i++) {
          ...
          row.onclick = function(){
            ...
            searchedUserlModalAdress.innerHTML = "He/She is avalible at <br><b>Date</b>: " + this.data.teachingDay + this.data.teachingTime + "<b>Place</b>: <a href=" + this.data.location + ">" + this.data.location + "</a><br>";
