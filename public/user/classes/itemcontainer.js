  ...
  var maxPointFilter = new PIXI.filters.GlowFilter(8,2,2, 0x007F0E, 1);
  var notNullPointFilter = new PIXI.filters.GlowFilter(8,2,2, 0xCCAA00, 1);
  var hoverFilter = new PIXI.filters.GlowFilter(8,2,2, 0xFFBF00, 1);
