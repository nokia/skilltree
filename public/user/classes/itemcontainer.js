...
//      this.skillborder_maxpoint.levelinfo.scale.set(.5);
    ...
    onButtonOver() {
        ...
        this.parentObj.setFilter(this.parentObj, hoverFilter, this.parentObj.skills.filters[1]);
    ...
    onButtonOut() {
        ...
        this.parentObj.setFilter(this.parentObj, nullFilter, this.parentObj.skills.filters[1]);
