class Tree {
    constructor (app, skills) {
        ...
        for(var i = 0; i < this.skills.length; i++){
          ...
          this.skills[i].itemcontainer.container.position.x = rand() * 500;//this.skills[i].place * 130 + (app.renderer.width - levelLength[this.skills[i].level] * 130) / 2;
          this.skills[i].itemcontainer.container.position.y = rand() * 500;//this.skills[i].level * 150;
